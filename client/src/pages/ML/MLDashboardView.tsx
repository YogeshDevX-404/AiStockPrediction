      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 glass-panel p-6 border-purple-500/20 bg-gradient-to-r from-purple-950/30 via-card to-emerald-950/20">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-black font-display text-white">Machine Learning MLOps Platform</h1>
          ...
          <p className="text-xs text-slate-400">Probabilistic forecasting engine, SHAP feature importance, model registry, and dataset training pipelines.</p>
        </div>

        <div className="flex items-center space-x-2 w-full sm:w-auto">
          <Button variant="glass" size="sm" leftIcon={<Layers className="w-4 h-4 text-purple-400" />} onClick={() => navigate('/ml/registry')}>
            Model Registry
          </Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-bold text-white uppercase tracking-wider">Champion & Challenger Forecasting Models</h2>
