    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex items-center justify-between glass-panel p-6 border-border/50">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-black font-display text-foreground">Subscription Entitlements & Features</h1>
            <Badge variant="purple">{subscription.planTier} PLAN</Badge>
          </div>
          <p className="text-xs text-muted-foreground">View active feature entitlements, query limits, and consumption gauges.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <GlassCard className="p-6 space-y-4">
          <h2 className="text-base font-bold text-foreground font-display border-b border-border/50 pb-3">Feature Entitlements Matrix</h2>
