    ...
    <div className="min-h-screen bg-[#050816] text-white flex items-center justify-center p-4 sm:px-6 lg:px-8 relative overflow-hidden selection:bg-emerald-500/30">
      ...
      <GlassCard className="w-full max-w-md p-8 space-y-6 relative z-10 border border-white/15 rounded-[32px] bg-[#070c1d]/90 shadow-2xl backdrop-blur-2xl">
        <div className="space-y-2 text-center">
          ...
          <h1 className="text-2xl font-black font-display text-white">Create New Password</h1>
          <p className="text-xs text-slate-400">Choose a new secure password for your TradeGenius AI account.</p>
        </div>
          ...
          {newPassword && (
            <div className="space-y-2 p-3 rounded-xl bg-white/5 border border-white/10 text-xs">
              <div className="flex items-center justify-between font-bold">
                ...
                <span className={score >= 4 ? 'text-emerald-400' : 'text-amber-400'}>
