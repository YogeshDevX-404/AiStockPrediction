    ...
    <GlassCard glow className="p-6 space-y-4 border-purple-500/30 bg-gradient-to-br from-purple-950/30 via-card to-emerald-950/20">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-lg font-black text-white font-display">Aggregated Multi-Broker Portfolio</h2>
            <p className="text-xs text-slate-400">Consolidated balance across Zerodha, Upstox, Alpaca, & IBKR accounts</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 text-center">
        <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-1">
          <span className="text-[10px] text-slate-400 font-bold uppercase">Combined Cash Funds</span>
          <div className="text-2xl font-black text-white font-mono">{formatCurrency(totalCash)}</div>
        </div>

        <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-1">
          <span className="text-[10px] text-slate-400 font-bold uppercase">Combined Buying Power</span>
          <div className="text-2xl font-black text-purple-400 font-mono">{formatCurrency(totalBuyingPower)}</div>
        </div>
      </div>
    </GlassCard>
  );
