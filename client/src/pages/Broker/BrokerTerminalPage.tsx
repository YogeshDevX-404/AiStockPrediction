      ...
      <div className="flex items-center justify-between glass-panel p-6 border-white/10">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-black font-display text-white">Smart Broker Order Execution Terminal</h1>
          </div>
          <p className="text-xs text-slate-400">Direct live order routing gateway to Zerodha, Upstox, Alpaca, and Interactive Brokers.</p>
        </div>
