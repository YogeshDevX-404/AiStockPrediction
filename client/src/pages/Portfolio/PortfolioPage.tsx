  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 glass-panel p-6 border-emerald-500/20 bg-gradient-to-r from-emerald-950/30 via-card to-purple-950/20">
        <div>
          <h1 className="text-2xl font-black font-display text-white">Portfolio Command Center</h1>
          <p className="text-xs text-slate-400">Track active holdings, asset allocation, passive dividend yield, and AI rebalancing.</p>
        </div>
