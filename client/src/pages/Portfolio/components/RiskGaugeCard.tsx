    ...
    <GlassCard glow className="p-6 space-y-6 border-purple-500/30 bg-gradient-to-br from-purple-950/30 via-card to-emerald-950/20">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-lg font-black text-white font-display">Portfolio Health & Risk Rating</h2>
            <p className="text-xs text-slate-400">Quantitative Risk Engine Metric Analysis</p>
          </div>
        </div>

        <div className="text-right">
          <div className="text-3xl font-black text-emerald-400 font-display">{metrics.healthScore}/100</div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
        <div className="p-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 space-y-1">
          ...
          <div className="text-xl font-black text-emerald-400 font-mono">{metrics.sharpeRatio}</div>
          <p className="text-[10px] text-slate-400">Risk-Adjusted Return</p>
        </div>
        ...
        <div className="p-3.5 rounded-2xl bg-purple-500/10 border border-purple-500/20 space-y-1">
          ...
          <div className="text-xl font-black text-purple-400 font-mono">{metrics.beta}</div>
          <p className="text-[10px] text-slate-400">Market Sensitivity</p>
        </div>
        ...
        <div className="p-3.5 rounded-2xl bg-red-500/10 border border-red-500/20 space-y-1">
          ...
          <div className="text-xl font-black text-red-400 font-mono">{metrics.maxDrawdown}%</div>
          <p className="text-[10px] text-slate-400">Peak-to-Trough Decline</p>
        </div>

        <div className="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/20 space-y-1">
          <span className="text-[10px] text-amber-300 font-bold uppercase">Value at Risk (VaR 95%)</span>
          <div className="text-xl font-black text-amber-400 font-mono">{metrics.valueAtRisk95}%</div>
          <p className="text-[10px] text-slate-400">1-Day Max Loss Risk</p>
        </div>
      </div>
    </GlassCard>
  );
