    ...
    <GlassCard className="space-y-4">
      <div className="flex items-center justify-between border-b border-border/50 pb-3">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-base font-bold font-display text-foreground">Wall Street Analyst Recommendations</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        <div className="space-y-2.5 text-xs">
          <div className="flex justify-between items-center text-muted-foreground">
            ...
            <div className="w-48 bg-foreground/10 h-2 rounded-full overflow-hidden ml-2">
        ...
        <div className="p-4 rounded-2xl bg-foreground/5 border border-border/40 space-y-2 text-center">
          <div className="text-[10px] text-muted-foreground font-bold uppercase">Consensus 12-Month Price Target</div>
          <div className="text-3xl font-black text-emerald-600 dark:text-emerald-400 font-display">{formatCurrency(ratings.targetPrice)}</div>
          <p className="text-xs text-muted-foreground">Based on 49 Wall Street analyst price projections</p>
        </div>
      </div>
    </GlassCard>
  );
