    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between glass-panel p-6 border-border/50">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-black font-display text-foreground">AI Strategy Executive Report</h1>
            <Badge variant="emerald">OVERFITTING RISK: {report.overfittingRisk}</Badge>
          </div>
          <p className="text-xs text-muted-foreground">Automated AI evaluation auditing strategy strengths, weaknesses, and optimization suggestions.</p>
        </div>
      ...
      <GlassCard glow className="p-6 space-y-6 border-purple-500/30 bg-gradient-to-br from-purple-950/30 via-card to-emerald-950/20">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-lg font-black text-foreground font-display">Executive Summary Digest</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div className="p-4 rounded-2xl bg-foreground/5 border border-border/50 space-y-2">
            <span className="font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider text-[11px] block">Key Strategy Strengths</span>
          ...
          <div className="p-4 rounded-2xl bg-foreground/5 border border-border/50 space-y-2">
            <span className="font-bold text-amber-500 dark:text-amber-400 uppercase tracking-wider text-[11px] block">Identified Weaknesses & Risk</span>
        ...
        <div className="space-y-2 text-xs border-t border-border/50 pt-4">
          <span className="font-bold text-foreground uppercase tracking-wider text-[11px] block">AI Optimization Guidance:</span>
