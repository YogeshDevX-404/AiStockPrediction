          ...
          <GlassCard className="p-6 border border-white/15 rounded-[32px] bg-[#070b1c]/90 shadow-2xl space-y-6">
            ...
            <div className="flex items-center justify-between border-b border-border/50 pb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-bold text-base text-foreground font-display">TradeGenius Financial Assistant</h3>
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="flex items-start space-x-3 max-w-xl ml-auto flex-row-reverse space-x-reverse">
                ...
                <div className="p-4 rounded-2xl bg-primary text-foreground font-medium rounded-tr-none shadow-lg">
              ...
              <div className="flex items-start space-x-3 max-w-2xl">
                ...
                <div className="p-5 rounded-2xl glass-panel border border-border/50 text-slate-200 rounded-tl-none space-y-3">
                  <p className="leading-relaxed">
                    Based on our real-time multi-factor neural analysis for <strong className="text-foreground">Tesla, Inc. (TSLA)</strong>:
                  </p>
                  ...
                  <div className="p-3.5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-between mt-2">
                    ...
                    <div className="text-xs font-bold text-foreground">
                      AI Confidence: <span className="text-purple-600 dark:text-purple-400 font-mono text-sm">82%</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Input Bar Mock */}
            <div className="p-3 rounded-2xl glass-panel border border-border/50 flex items-center justify-between text-muted-foreground text-xs">
              <span>Ask follow up question (e.g., What is the stop loss for TSLA?)...</span>
              <button className="p-2 rounded-xl bg-primary text-foreground">
