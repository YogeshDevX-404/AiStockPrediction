      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-6 space-y-8 text-left">
          <motion.div
            ...
            className="inline-flex items-center space-x-2 px-4 py-2 rounded-full glass-pill border border-emerald-500/30 text-emerald-400 text-xs font-bold tracking-wide uppercase shadow-lg shadow-emerald-950/40"
          >
          ...
          >
            <div>
              <div className="text-2xl font-black font-display text-white">$14.2B+</div>
              <div className="text-xs text-slate-400">Assets Tracked</div>
            </div>
            <div>
              <div className="text-2xl font-black font-display text-emerald-400">94.8%</div>
              <div className="text-xs text-slate-400">Model Accuracy</div>
            </div>
            <div>
              <div className="text-2xl font-black font-display text-purple-400">&lt;15ms</div>
              <div className="text-xs text-slate-400">Signal Latency</div>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="relative glass-card p-5 border border-white/15 rounded-[24px] shadow-2xl bg-[#090e1f]/80 backdrop-blur-2xl space-y-4 overflow-hidden">
            ...
            <div className="flex items-center justify-between pb-3 border-b border-white/10">
              ...
              <div className="text-[11px] font-mono text-slate-400">TradeGenius AI • Neural Engine v4.8</div>
              <span className="flex items-center text-[10px] text-emerald-400 font-bold px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20">
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center space-x-2">
                  <span className="text-lg font-black font-display text-white">NVDA</span>
                  <span className="text-xs text-slate-400">NVIDIA Corp</span>
                  <span className="text-xs font-bold text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-md border border-emerald-500/20">
                    +3.45%
                  </span>
                </div>
                <div className="text-3xl font-black font-display text-white mt-1">$132.40</div>
              </div>

              <div className="p-3 rounded-2xl bg-purple-500/10 border border-purple-500/20 text-purple-400 space-y-1 text-right">
                <div className="text-[10px] uppercase font-bold text-purple-300">AI Recommendation</div>
                <div className="text-sm font-black text-emerald-400 flex items-center justify-end">
                  <Zap className="w-4 h-4 mr-1 text-emerald-400" /> STRONG BUY
                </div>
              </div>
            </div>

            {/* Mock Animated Chart Lines */}
            <div className="h-44 w-full relative flex items-end justify-between px-2 pt-4 pb-2 border-b border-white/10 overflow-hidden">
              ...
              {/* Pulsing Target Dot */}
              <div className="absolute top-[10px] right-[10px] w-4 h-4 rounded-full bg-emerald-400/40 flex items-center justify-center animate-ping">
            ...
            <div className="grid grid-cols-2 gap-3 pt-1">
              <div className="p-3 rounded-xl bg-white/[0.04] border border-white/10 flex items-center space-x-3">
                <div className="p-2 rounded-lg bg-emerald-500/10 text-emerald-400">
                  <Activity className="w-4 h-4" />
                </div>
                <div>
                  <div className="text-[10px] text-slate-400 font-bold uppercase">Confidence Score</div>
                  <div className="text-sm font-extrabold text-white">94.8% (Extreme High)</div>
                </div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-white/[0.04] border border-white/10 flex items-center space-x-3">
                ...
                <div>
                  <div className="text-[10px] text-slate-400 font-bold uppercase">30D Target</div>
                  <div className="text-sm font-extrabold text-emerald-400">$155.00 (+17.0%)</div>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div>
              <div className="text-[11px] text-slate-400 font-bold uppercase">Portfolio Day Profit</div>
              <div className="text-lg font-black text-emerald-400 font-display">+$3,420.12 (+2.35%)</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs font-bold text-white">TSLA Bullish MACD Crossover</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
