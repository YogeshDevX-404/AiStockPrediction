      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 glass-panel p-6 border-purple-500/20 bg-gradient-to-r from-purple-950/30 via-card to-emerald-950/20">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-black font-display text-white">Smart Alert & Event Trigger Engine</h1>
          ...
          <p className="text-xs text-slate-400">Configure multi-condition triggers for Price Targets, RSI Technicians, AI Predictions, and Breaking News.</p>
        </div>
        ...
        <div className="flex items-center space-x-2 w-full sm:w-auto">
          ...
          <Button variant="glass" size="md" leftIcon={<History className="w-4 h-4 text-purple-400" />} onClick={() => navigate('/alerts/history')}>
            Audit Log
          </Button>
        </div>
      </div>
