      ...
      <div className="flex items-center justify-between glass-panel p-6 border-border/50">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-black font-display text-foreground">System Infrastructure & Server Health</h1>
          </div>
          <p className="text-xs text-muted-foreground">Real-time resource utilization, database latency, and WebSocket connection pools.</p>
        </div>
