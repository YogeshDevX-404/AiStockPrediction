      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 glass-panel p-6 border-purple-500/20 bg-gradient-to-r from-purple-950/30 via-card to-emerald-950/20">
        <div>
          <div className="flex items-center space-x-2">
            <h1 className="text-2xl font-black font-display text-white">AI Smart Watchlist Monitor</h1>
          ...
          <p className="text-xs text-slate-400">Continuous neural scanner tracking momentum, RSI breakouts, and volume anomalies.</p>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <Button
            variant="glass"
            size="md"
            leftIcon={<GitCompare className="w-4 h-4 text-amber-400" />}
