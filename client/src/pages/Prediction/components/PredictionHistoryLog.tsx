    ...
    <GlassCard className="space-y-4">
      <div className="flex items-center justify-between border-b border-border/50 pb-3">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-base font-bold font-display text-foreground">Historical Model Prediction Accuracy Log</h2>
        </div>
          ...
          <tbody className="divide-y divide-white/5">
            {history.map((item) => (
              <tr key={item.id} className="hover:bg-foreground/5">
                ...
                <td className="py-3 text-emerald-600 dark:text-emerald-400 font-bold">+{item.pnlPercent}%</td>
